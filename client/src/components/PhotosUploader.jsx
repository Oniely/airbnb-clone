    ...
    <>
      <div className="flex gap-2">
        ...
        <button
          ...
          className="grow rounded-2xl bg-gray-200 px-4"
        >
          Add&nbsp;photos
        </button>
      </div>
      <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        {addedPhotos.length > 0 &&
          addedPhotos.map((link) => (
            <div className="relative flex h-44" key={link}>
              <img
              ...
              <button
                ...
                className="absolute bottom-1 right-1 rounded-xl bg-black bg-opacity-20 px-3 py-2 text-white hover:bg-opacity-50 hover:text-red-500"
              >
                <svg
